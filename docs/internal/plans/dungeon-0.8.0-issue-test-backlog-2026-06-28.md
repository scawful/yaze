...
4. **Sparse pixel overlap assertion for object stream ordering**
   - Status: room `0x001` now has a sparse object BG1/BG2 overlap pixel
     assertion that compares the composed pixel against the expected SNES Mode 1
     priority winner (`BG2 low < BG1 low < BG2 high < BG1 high`).
