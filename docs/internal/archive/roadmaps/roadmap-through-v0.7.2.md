# Archived Yaze roadmap through v0.7.2

> Frozen on 2026-09-14 when the active roadmap moved to workflow-based
> tester-readiness gates. This snapshot preserves completed release history
> and former status details; it is not the current source of project priorities.
