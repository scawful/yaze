...
if(YAZE_USE_GLFW)
  add_compile_definitions(YAZE_USE_GLFW)
endif()
...
if(YAZE_USE_GLFW)
  message(STATUS "  Window Backend: GLFW (scaffold)")
elseif(YAZE_USE_SDL3)
  message(STATUS "  Window Backend: SDL3 (experimental)")
else()
  message(STATUS "  Window Backend: SDL2 (stable)")
endif()
