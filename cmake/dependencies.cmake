...
# z3dk integration (experimental; mutually exclusive with YAZE_ENABLE_ASAR)
if(YAZE_ENABLE_Z3DK AND NOT EMSCRIPTEN)
  include(cmake/dependencies/z3dk.cmake)
  if(YAZE_Z3DK_FOUND)
    list(APPEND YAZE_ALL_DEPENDENCIES ${YAZE_Z3DK_TARGETS})
  endif()
endif()
...
if(YAZE_ENABLE_Z3DK AND NOT EMSCRIPTEN)
  message(STATUS "z3dk: ${YAZE_Z3DK_FOUND} (${YAZE_Z3DK_TARGETS})")
endif()
message(STATUS "=================================")
