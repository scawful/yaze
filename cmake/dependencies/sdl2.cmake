...
if(NOT TARGET yaze_sdl2)
  ...
  elseif(TARGET SDL2::SDL2-static)
    ...
    if(YAZE_PLATFORM_MACOS)
      ...
      yaze_homebrew_find_package(sdl2 RESULT_VAR _yaze_sdl2_hb)
      if(_yaze_sdl2_hb AND EXISTS "${_yaze_sdl2_hb}/include/SDL2")
        target_include_directories(yaze_sdl2 INTERFACE "${_yaze_sdl2_hb}/include/SDL2")
      endif()
    endif()
  else()
