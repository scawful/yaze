...
# Explicitly find and cache Abseil include directory from gRPC-bundled Abseil
if(TARGET absl::base)
  ...
  if(_absl_base_source_dir AND NOT _absl_base_source_dir STREQUAL "NOTFOUND")
    ...
    if(EXISTS "${_absl_root_dir}")
      set(YAZE_ABSL_INCLUDE_DIR "${_absl_root_dir}" CACHE INTERNAL "Abseil include directory from gRPC")
      message(STATUS "Found gRPC-bundled Abseil include directory: ${_absl_root_dir}")
    endif()
  endif()
    ...
    foreach(_inc IN LISTS _absl_interface_includes)
      if(_inc MATCHES "\\$<BUILD_INTERFACE:([^>]+)>")
        ...
        if(EXISTS "${_absl_inc_path}")
          set(YAZE_ABSL_INCLUDE_DIR "${_absl_inc_path}" CACHE INTERNAL "Abseil include directory from gRPC")
          message(STATUS "Found gRPC-bundled Abseil include directory: ${_absl_inc_path}")
          break()
        endif()
      elseif(NOT _inc MATCHES "\\$<" AND EXISTS "${_inc}")
        set(YAZE_ABSL_INCLUDE_DIR "${_inc}" CACHE INTERNAL "Abseil include directory from gRPC")
        message(STATUS "Found gRPC-bundled Abseil include directory: ${_inc}")
        break()
      endif()
    endforeach()
  endif()
