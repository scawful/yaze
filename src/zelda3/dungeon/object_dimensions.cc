...
void ObjectDimensionTable::InitializeDefaults() {
  ...
  // 0x05-0x06: Wall 2x4 spaced 4 BothBG - step is 6 tiles between starts
  for (int id = 0x05; id <= 0x06; id++) {
    dimensions_[id] = {2, 4, Dir::Horizontal, 6, false};
  }
  ...
  // ============================================================================
  // Chests - fixed 4x4 (matches DrawChest bounding size)
  // ============================================================================
