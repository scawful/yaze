...
void ObjectDrawer::InitializeDrawRoutines() {
  ...
  object_to_routine_map_[0x22] =
      21;  // RoomDraw_RightwardsHasEdge1x1_1to16_plus3
  // 0x23-0x2E all use RoomDraw_RightwardsHasEdge1x1_1to16_plus2
  for (int id = 0x23; id <= 0x2E; id++) {
    object_to_routine_map_[id] = 22;
  }
  object_to_routine_map_[0x2F] =
      23;  // RoomDraw_RightwardsTopCorners1x2_1to16_plus13
  object_to_routine_map_[0x30] =
  ...
  if (core::FeatureFlags::get().kEnableCustomObjects) {
    ...
    object_to_routine_map_[0x31] =
        DrawRoutineIds::kCustomObject;  // Custom tracks
    object_to_routine_map_[0x32] =
        DrawRoutineIds::kCustomObject;  // Custom furniture
  } else {
  ...
  object_to_routine_map_[0x49] =
      40;  // Rightwards4x2 (4 cols × 2 rows, horizontal spacing)
