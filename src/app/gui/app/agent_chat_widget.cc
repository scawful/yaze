...
void AgentChatWidget::Render(bool* p_open) {
  ...
  ImGui::BeginChild("ChatHistory",
                    ImVec2(0, -ImGui::GetFrameHeightWithSpacing() - 60), true,
...
void AgentChatWidget::RenderMessageBubble(const cli::agent::ChatMessage& msg,
                                          int index) {
...
void AgentChatWidget::RenderInputArea() {
  ...
  bool enter_pressed = ImGui::InputTextMultiline(
      "##input", input_buffer_, sizeof(input_buffer_), ImVec2(-1, 60),
