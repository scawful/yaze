...
class BppFormatUI {
 public:
   ...
   */
  void RenderAnalysisPanel(const gfx::Bitmap& bitmap,
   ...
   */
  void RenderConversionPreview(const gfx::Bitmap& bitmap,
   ...
   */
  bool IsConversionAvailable(gfx::BppFormat from_format,
   ...
   */
  int GetConversionEfficiency(gfx::BppFormat from_format,
                              gfx::BppFormat to_format) const;
 ...
 private:
  ...
  void UpdateAnalysisCache(int sheet_id,
