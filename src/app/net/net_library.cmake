  ...
  if(NOT YAZE_WITH_GRPC)
    ...
    if(NOT WIN32 AND NOT YAZE_PLATFORM_IOS)
      ...
      if(OPENSSL_FOUND)
        ...
        target_compile_definitions(yaze_net PUBLIC CPPHTTPLIB_OPENSSL_SUPPORT)
        message(STATUS "  - WebSocket with SSL/TLS support enabled via OpenSSL (gRPC mode)")
      else()
        message(STATUS "  - gRPC mode without OpenSSL detected; WebSocket using plain HTTP")
      endif()
    else()
