#ifndef YAZE_APP_EDITOR_OVERWORLD_UI_CANVAS_OVERWORLD_CANVAS_VIEW_H
#define YAZE_APP_EDITOR_OVERWORLD_UI_CANVAS_OVERWORLD_CANVAS_VIEW_H
...
/**
 * @class OverworldCanvasView
 * @brief WindowContent wrapper for the main overworld canvas.
 *
 ...
 */
class OverworldCanvasView : public WindowContent {
 public:
...
#endif  // YAZE_APP_EDITOR_OVERWORLD_UI_CANVAS_OVERWORLD_CANVAS_VIEW_H
