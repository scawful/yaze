...
void SettingsPanel::DrawProjectSettings() {
  ...
  if (ImGui::Checkbox(tr("Backup Before Save"), &backup_on_save)) {
  ...
  if (ImGui::InputInt(tr("Retention Count"), &retention)) {
...
void SettingsPanel::DrawAIAgentSettings() {
  ...
  if (ImGui::Button(tr("Add LM Studio"))) {
    ...
    host.base_url = "http://localhost:1234";
    host.api_type = cli::kProviderLmStudio;
  ...
  if (ImGui::Button(tr("Add AFS Bridge"))) {
    ...
    host.api_type = cli::kProviderOpenAi;
    host.supports_tools = true;
    host.supports_streaming = true;
    add_host(host);
  }
  ...
  if (ImGui::Button(tr("Add Ollama"))) {
    ...
    host.api_type = cli::kProviderOllama;
    host.supports_tools = true;
    host.supports_streaming = true;
    add_host(host);
  }
