#ifndef YAZE_APP_EDITOR_SHELL_WINDOWS_SELECTION_PROPERTIES_PANEL_H_
#define YAZE_APP_EDITOR_SHELL_WINDOWS_SELECTION_PROPERTIES_PANEL_H_
...
class SelectionPropertiesPanel {
 ...
 private:
  ...
  bool DrawPositionEditor(const char* label, int* x, int* y, int min_val = 0,
                          int max_val = 512);
...
#endif  // YAZE_APP_EDITOR_SHELL_WINDOWS_SELECTION_PROPERTIES_PANEL_H_
