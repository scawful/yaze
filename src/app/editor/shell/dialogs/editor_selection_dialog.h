#ifndef YAZE_APP_EDITOR_SHELL_DIALOGS_EDITOR_SELECTION_DIALOG_H_
#define YAZE_APP_EDITOR_SHELL_DIALOGS_EDITOR_SELECTION_DIALOG_H_
...
#endif  // YAZE_APP_EDITOR_SHELL_DIALOGS_EDITOR_SELECTION_DIALOG_H_
