#ifndef YAZE_APP_EDITOR_SHELL_COORDINATOR_WORKSPACE_MANAGER_H_
#define YAZE_APP_EDITOR_SHELL_COORDINATOR_WORKSPACE_MANAGER_H_
...
#endif  // YAZE_APP_EDITOR_SHELL_COORDINATOR_WORKSPACE_MANAGER_H_
