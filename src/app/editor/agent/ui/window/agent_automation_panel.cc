#include "app/editor/agent/ui/window/agent_automation_panel.h"
...
void AgentAutomationPanel::Draw(AgentUIContext* context,
  ...
  if (ImGui::BeginChild("Automation_Panel", ImVec2(0, 240), true)) {
    ...
    if (connected) {
      ...
      status_color =
          ImVec4(success.x, success.y * green_pulse, success.z, 1.0f);
      status_text = "ONLINE";
    ...
    ImGui::TextColored(gui::GetInfoColor(), "%s RECENT ACTIONS", ICON_MD_LIST);
    ImGui::SameLine();
