#ifndef YAZE_APP_EDITOR_HACK_ORACLE_UI_ANNOTATION_OVERLAY_PANEL_H
#define YAZE_APP_EDITOR_HACK_ORACLE_UI_ANNOTATION_OVERLAY_PANEL_H
...
#endif  // YAZE_APP_EDITOR_HACK_ORACLE_UI_ANNOTATION_OVERLAY_PANEL_H
