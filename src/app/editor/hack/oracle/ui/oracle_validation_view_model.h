...
#ifndef YAZE_APP_EDITOR_HACK_ORACLE_UI_ORACLE_VALIDATION_VIEW_MODEL_H_
#define YAZE_APP_EDITOR_HACK_ORACLE_UI_ORACLE_VALIDATION_VIEW_MODEL_H_
...
#endif  // YAZE_APP_EDITOR_HACK_ORACLE_UI_ORACLE_VALIDATION_VIEW_MODEL_H_
