#ifndef YAZE_APP_EDITOR_HACK_ORACLE_UI_ORACLE_VALIDATION_PANEL_H_
#define YAZE_APP_EDITOR_HACK_ORACLE_UI_ORACLE_VALIDATION_PANEL_H_
...
#endif  // YAZE_APP_EDITOR_HACK_ORACLE_UI_ORACLE_VALIDATION_PANEL_H_
