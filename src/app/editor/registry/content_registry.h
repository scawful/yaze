#ifndef YAZE_APP_EDITOR_REGISTRY_CONTENT_REGISTRY_H_
#define YAZE_APP_EDITOR_REGISTRY_CONTENT_REGISTRY_H_
...
/** @brief Alias for `Panels`; preferred name for `WindowContent` registration. */
namespace WindowContents = Panels;
...
#endif  // YAZE_APP_EDITOR_REGISTRY_CONTENT_REGISTRY_H_
