#ifndef YAZE_APP_EDITOR_REGISTRY_PANEL_REGISTRATION_H_
#define YAZE_APP_EDITOR_REGISTRY_PANEL_REGISTRATION_H_
...
#define REGISTER_PANEL_FACTORY(PanelClass, FactoryFunc)                      \
  ...
  struct PanelRegistrar_##PanelClass {                                       \
    PanelRegistrar_##PanelClass() {                                          \
      ::yaze::editor::ContentRegistry::Panels::RegisterFactory(FactoryFunc); \
    }                                                                        \
  };                                                                         \
  [[maybe_unused]] static PanelRegistrar_##PanelClass                        \
      s_panel_registrar_##PanelClass;                                        \
...
/** @brief Preferred macro name for registering `WindowContent` types. */
#define REGISTER_WINDOW_CONTENT REGISTER_PANEL
/** @brief Preferred macro name for registering `WindowContent` factories. */
#define REGISTER_WINDOW_CONTENT_FACTORY REGISTER_PANEL_FACTORY

}  // namespace yaze::editor

#endif  // YAZE_APP_EDITOR_REGISTRY_PANEL_REGISTRATION_H_
