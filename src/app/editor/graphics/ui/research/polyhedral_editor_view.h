#ifndef YAZE_APP_EDITOR_GRAPHICS_RESEARCH_POLYHEDRAL_EDITOR_VIEW_H_
#define YAZE_APP_EDITOR_GRAPHICS_RESEARCH_POLYHEDRAL_EDITOR_VIEW_H_
...
class PolyhedralEditorView : public WindowContent {
 public:
  explicit PolyhedralEditorView(Rom* rom = nullptr) : rom_(rom) {}
...
#endif  // YAZE_APP_EDITOR_GRAPHICS_RESEARCH_POLYHEDRAL_EDITOR_VIEW_H_
