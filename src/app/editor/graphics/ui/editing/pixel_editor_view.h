#ifndef YAZE_APP_EDITOR_GRAPHICS_PIXEL_EDITOR_VIEW_H
#define YAZE_APP_EDITOR_GRAPHICS_PIXEL_EDITOR_VIEW_H
...
/**
 * @brief Main pixel editing view for graphics sheets
 *
 * Provides a full-featured pixel editor with tools for drawing,
 * selecting, and manipulating graphics data.
 */
class PixelEditorView : public WindowContent {
 public:
  explicit PixelEditorView(GraphicsEditorState* state, Rom* rom,
...
#endif  // YAZE_APP_EDITOR_GRAPHICS_PIXEL_EDITOR_VIEW_H
