#include "app/editor/graphics/ui/browser/sheet_browser_view.h"
...
void SheetBrowserView::Initialize() {
  // Initialize with sensible defaults
  thumbnail_scale_ = 2.0f;
  columns_ = 2;
}

void SheetBrowserView::Draw(bool* p_open) {
...
absl::Status SheetBrowserView::Update() {
  DrawSearchBar();
  ImGui::Separator();
  DrawBatchOperations();
  ImGui::Separator();
...
void SheetBrowserView::DrawSearchBar() {
  ImGui::Text("Search:");
  ImGui::SameLine();
...
void SheetBrowserView::DrawBatchOperations() {
...
void SheetBrowserView::DrawSheetGrid() {
...
void SheetBrowserView::DrawSheetThumbnail(int sheet_id, gfx::Bitmap& bitmap) {
  const float thumb_width = 128 * thumbnail_scale_;
  const float thumb_height = 32 * thumbnail_scale_;
