#ifndef YAZE_APP_EDITOR_GRAPHICS_SHEET_BROWSER_VIEW_H
#define YAZE_APP_EDITOR_GRAPHICS_SHEET_BROWSER_VIEW_H
 ...
 */
class SheetBrowserView : public WindowContent {
 public:
  explicit SheetBrowserView(GraphicsEditorState* state) : state_(state) {}
...
#endif  // YAZE_APP_EDITOR_GRAPHICS_SHEET_BROWSER_VIEW_H
