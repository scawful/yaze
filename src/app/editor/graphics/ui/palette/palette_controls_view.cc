...
void PaletteControlsView::Initialize() {
...
void PaletteControlsView::DrawPresets() {
...
void PaletteControlsView::DrawPaletteGroupSelector() {
...
void PaletteControlsView::DrawPaletteDisplay() {
...
void PaletteControlsView::DrawApplyButtons() {
...
void PaletteControlsView::ApplyPaletteToSheet(uint16_t sheet_id) {
...
void PaletteControlsView::ApplyPaletteToAllSheets() {
  if (!rom_ || !rom_->is_loaded() || !game_data_)
    return;
