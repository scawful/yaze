#ifndef YAZE_APP_EDITOR_GRAPHICS_PALETTE_CONTROLS_VIEW_H
#define YAZE_APP_EDITOR_GRAPHICS_PALETTE_CONTROLS_VIEW_H
...
/**
 * @brief View for managing palettes applied to graphics sheets
 *
 * Provides palette group selection, quick presets, and
 * apply-to-sheet functionality.
 */
class PaletteControlsView : public WindowContent {
 public:
  explicit PaletteControlsView(GraphicsEditorState* state, Rom* rom,
...
#endif  // YAZE_APP_EDITOR_GRAPHICS_PALETTE_CONTROLS_VIEW_H
