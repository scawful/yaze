...
void PalettesetEditorView::Draw(bool* p_open) {
  Update().IgnoreError();
}

absl::Status PalettesetEditorView::Update() {
...
void PalettesetEditorView::DrawPalettesetList() {
...
void PalettesetEditorView::DrawPalettesetEditor() {
...
void PalettesetEditorView::DrawPalettePreview(gfx::SnesPalette& palette,
                                              const char* label) {
  PushID(label);
...
void PalettesetEditorView::DrawPaletteGrid(gfx::SnesPalette& palette,
                                           bool editable) {
  if (palette.empty()) {
    Text("(Empty palette)");
    return;
