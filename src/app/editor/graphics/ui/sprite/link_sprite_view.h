#ifndef YAZE_APP_EDITOR_GRAPHICS_LINK_SPRITE_VIEW_H
#define YAZE_APP_EDITOR_GRAPHICS_LINK_SPRITE_VIEW_H
...
/**
 * @brief Dedicated view for editing Link's 14 graphics sheets
 *
 * Features:
 ...
 */
class LinkSpriteView : public WindowContent {
 public:
  ...
  /**
   * @brief Initialize the view and load Link sheets
   */
  void Initialize();

  /**
   * @brief Draw the view UI (WindowContent interface)
   */
  ...
  /**
   * @brief Check if the view has unsaved changes
   */
...
#endif  // YAZE_APP_EDITOR_GRAPHICS_LINK_SPRITE_VIEW_H
