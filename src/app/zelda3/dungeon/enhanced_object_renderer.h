#ifndef YAZE_APP_ZELDA3_DUNGEON_ENHANCED_OBJECT_RENDERER_H
#define YAZE_APP_ZELDA3_DUNGEON_ENHANCED_OBJECT_RENDERER_H
...
/**
 * @brief Enhanced ObjectRenderer with comprehensive safety and performance optimizations
 * 
 * This class extends the base ObjectRenderer with:
 * - Comprehensive bounds checking to prevent segmentation faults
 * - Graphics sheet caching with LRU eviction
 ...
 */
class EnhancedObjectRenderer : public ObjectRenderer {
 public:
  explicit EnhancedObjectRenderer(Rom* rom);
  ~EnhancedObjectRenderer() = default;
...
/**
 * @brief Factory function to create enhanced renderer
 */
...
#endif  // YAZE_APP_ZELDA3_DUNGEON_ENHANCED_OBJECT_RENDERER_H