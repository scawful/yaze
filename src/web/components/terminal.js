...
(function() {
  ...
  function showHelp() {
    const helpText = [
      ...
      '  help <command>     Show z3ed command help',
      '  rom info           Show ROM metadata',
      '  overworld-describe-map --map=80',
      '  dungeon-describe-room --room=1',
      '  ai query <question>   Ask AI about ROM data',
