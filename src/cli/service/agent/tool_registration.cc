...
REGISTER_AGENT_TOOL("dungeon-export-custom-collision-json", "dungeon", "Export custom collision maps to JSON", "dungeon-export-custom-collision-json --out=<path> [--room=<id>|--rooms=<ids>|--all] [--report=<path>]", {}, true, true, DungeonExportCustomCollisionJsonCommandHandler)
REGISTER_AGENT_TOOL("dungeon-import-custom-collision-json", "dungeon", "Import custom collision maps from JSON", "dungeon-import-custom-collision-json --in=<path> [--dry-run] [--replace-all --force] [--report=<path>]", {}, true, true, DungeonImportCustomCollisionJsonCommandHandler)
REGISTER_AGENT_TOOL("dungeon-export-water-fill-json", "dungeon", "Export water fill zones to JSON", "dungeon-export-water-fill-json --out=<path> [--room=<id>|--rooms=<ids>|--all] [--report=<path>]", {}, true, true, DungeonExportWaterFillJsonCommandHandler)
REGISTER_AGENT_TOOL("dungeon-import-water-fill-json", "dungeon", "Import water fill zones from JSON", "dungeon-import-water-fill-json --in=<path> [--dry-run] [--strict-masks] [--report=<path>]", {}, true, true, DungeonImportWaterFillJsonCommandHandler)
