...
if(YAZE_ENABLE_AI_RUNTIME AND YAZE_ENABLE_JSON)
  ...
  if(NOT YAZE_ENABLE_REMOTE_AUTOMATION)
    ...
    # NOTE: On Windows CI, gRPC pulls bundled BoringSSL and linking OpenSSL here
    # creates duplicate SSL symbols at final link (yaze.exe).
    if(WIN32)
      message(STATUS "Windows + gRPC mode: OpenSSL disabled for yaze_agent to avoid BoringSSL symbol conflicts")
    else()
      ...
      if(OPENSSL_FOUND)
        ...
        message(STATUS "✓ SSL/HTTPS support enabled via OpenSSL (gRPC mode)")
      else()
        message(STATUS "gRPC mode without OpenSSL detected; HTTPS features disabled")
      endif()
    endif()
  endif()
endif()
...
# PNG::PNG is provided transitively via yaze_cli_core → render_service.cc
