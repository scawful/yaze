...
if(YAZE_ENABLE_JSON)
  ...
  if(TARGET yaze_httplib)
    target_link_libraries(yaze_agent PUBLIC yaze_httplib)
  else()
    message(FATAL_ERROR "yaze_httplib target not found. Ensure cmake/dependencies/httplib.cmake is included when JSON support is enabled.")
  endif()
