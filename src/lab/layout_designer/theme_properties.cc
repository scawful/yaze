...
std::string ThemeProperties::GenerateStyleCode() const {
  ...
  code +=
      absl::StrFormat("  style.ItemInnerSpacing = ImVec2(%.1ff, %.1ff);\n\n",
  ...
  code += absl::StrFormat("  style.WindowBorderSize = %.1ff;\n",
                          window_border_size);
  code +=
      absl::StrFormat("  style.ChildBorderSize = %.1ff;\n", child_border_size);
  code +=
      absl::StrFormat("  style.PopupBorderSize = %.1ff;\n", popup_border_size);
  code +=
      absl::StrFormat("  style.FrameBorderSize = %.1ff;\n", frame_border_size);
  code +=
      absl::StrFormat("  style.TabBorderSize = %.1ff;\n\n", tab_border_size);
...
void ThemePropertiesPanel::DrawPaddingSection(ThemeProperties& properties) {
  if (ImGui::CollapsingHeader(
          ICON_MD_SPACE_BAR " Padding",
          show_padding_ ? ImGuiTreeNodeFlags_DefaultOpen : 0)) {
    ImGui::SliderFloat2("Window Padding", &properties.window_padding.x, 0.0f,
                        20.0f, "%.0f");
    ImGui::SliderFloat2("Frame Padding", &properties.frame_padding.x, 0.0f,
                        20.0f, "%.0f");
    ImGui::SliderFloat2("Cell Padding", &properties.cell_padding.x, 0.0f, 20.0f,
                        "%.0f");
    ImGui::SliderFloat2("Item Spacing", &properties.item_spacing.x, 0.0f, 20.0f,
                        "%.0f");
    ImGui::SliderFloat2("Item Inner Spacing", &properties.item_inner_spacing.x,
                        0.0f, 20.0f, "%.0f");
  }
}
...
void ThemePropertiesPanel::DrawRoundingSection(ThemeProperties& properties) {
  if (ImGui::CollapsingHeader(
          ICON_MD_ROUNDED_CORNER " Rounding",
          show_rounding_ ? ImGuiTreeNodeFlags_DefaultOpen : 0)) {
    ImGui::SliderFloat("Window Rounding", &properties.window_rounding, 0.0f,
                       12.0f, "%.0f");
    ImGui::SliderFloat("Child Rounding", &properties.child_rounding, 0.0f,
                       12.0f, "%.0f");
    ImGui::SliderFloat("Frame Rounding", &properties.frame_rounding, 0.0f,
                       12.0f, "%.0f");
    ImGui::SliderFloat("Popup Rounding", &properties.popup_rounding, 0.0f,
                       12.0f, "%.0f");
    ImGui::SliderFloat("Scrollbar Rounding", &properties.scrollbar_rounding,
                       0.0f, 12.0f, "%.0f");
    ImGui::SliderFloat("Grab Rounding", &properties.grab_rounding, 0.0f, 12.0f,
                       "%.0f");
    ImGui::SliderFloat("Tab Rounding", &properties.tab_rounding, 0.0f, 12.0f,
                       "%.0f");
  }
}
...
void ThemePropertiesPanel::DrawBordersSection(ThemeProperties& properties) {
  if (ImGui::CollapsingHeader(
          ICON_MD_BORDER_ALL " Borders",
          show_borders_ ? ImGuiTreeNodeFlags_DefaultOpen : 0)) {
    ImGui::SliderFloat("Window Border", &properties.window_border_size, 0.0f,
                       2.0f, "%.0f");
    ImGui::SliderFloat("Child Border", &properties.child_border_size, 0.0f,
                       2.0f, "%.0f");
    ImGui::SliderFloat("Popup Border", &properties.popup_border_size, 0.0f,
                       2.0f, "%.0f");
    ImGui::SliderFloat("Frame Border", &properties.frame_border_size, 0.0f,
                       2.0f, "%.0f");
    ImGui::SliderFloat("Tab Border", &properties.tab_border_size, 0.0f, 2.0f,
                       "%.0f");
  }
}
...
void ThemePropertiesPanel::DrawSizesSection(ThemeProperties& properties) {
  if (ImGui::CollapsingHeader(
          ICON_MD_STRAIGHTEN " Sizes",
          show_sizes_ ? ImGuiTreeNodeFlags_DefaultOpen : 0)) {
    ImGui::SliderFloat("Indent Spacing", &properties.indent_spacing, 0.0f,
                       30.0f, "%.0f");
    ImGui::SliderFloat("Scrollbar Size", &properties.scrollbar_size, 1.0f,
                       20.0f, "%.0f");
    ImGui::SliderFloat("Grab Min Size", &properties.grab_min_size, 1.0f, 20.0f,
                       "%.0f");
  }
}
