...
resolve_test_directory
run_test_tier 1 "$UNIT_BIN" 'DrawRoutineMappingTest.*Plus3*:DrawRoutineMappingTest.*Plus23*:DrawRoutineMappingTest.*Corner*:DrawRoutineMappingTest.*DiagonalCeiling*:DrawRoutineMappingTest.MapsMovingWall*:DrawRoutineMappingTest.Thin*:DrawRoutineMappingTest.SanctuaryWall*:ObjectDrawerRegistryReplayTest.FloorCopy*:ObjectDrawerRegistryReplayTest.BuiltInWallRoutingAndDiagonalCount*:ObjectDrawerRegistryReplayTest.ConditionalEdgeCaps*:ObjectDrawerRegistryReplayTest.StraightInterroom*:ObjectDrawerRegistryReplayTest.WaterHopStairs*:ObjectDrawerRegistryReplayTest.MovingWalls*:ObjectDrawerRegistryReplayTest.BigHole*:ObjectDrawerRegistryReplayTest.TableRock*:ObjectDrawerRegistryReplayTest.FloodWater*:ObjectDrawerRegistryReplayTest.LongHorizontal*:ObjectDrawerRegistryReplayTest.RightwardsBarUsesUsdasmEndCapsAndRepeatedMiddleColumn:ObjectDrawerRegistryReplayTest.DownwardsBarUsesUsdasmTopThenBodyRows:ObjectDrawerRegistryReplayTest.SanctuaryWall*:ObjectDrawerRegistryReplayTest.FixedCorner*:ObjectDrawerRegistryReplayTest.Fixed4x4*:ObjectDrawerMaskPropagationTest.LaterBG1WriteClearsOnlyItsStreamRevealBit'
